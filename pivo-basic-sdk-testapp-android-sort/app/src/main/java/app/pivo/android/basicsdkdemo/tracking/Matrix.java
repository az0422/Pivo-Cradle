...
public class Matrix{
    ...
    public Matrix getSubmatrix(int row, int column, int rowCount, int colCount){
        ...
        Matrix result = new Matrix(rowCount,colCount);    // 행index와 열 index를 주면 0, 0에서부터 행index, 열index까지를 서브매트릭스로 반환
    ...
    public void setSubmatrix(int row, int column, int rowCount, int colCount, Matrix matrix){   // 우리가 Matrix를 만들때 입력한 data의 0:행,0:열 부분의 값을 matrix로 바꿈.
        if(row < 0 || row >= this.rowCount()){
    ...
    public Matrix(double[][] data){  // 2차원입니다.
    ...
    public Matrix( int rows, int columns){                            // Matrix를 선언하는 다양한 방법이네요. 0행렬을 만들어냅니다.
        this.rowCount = rows;
    ...
    public static Matrix zero(int rows, int columns){                  //row행 column열의 0행렬을 만들어냅니다.
    ...
    public static Matrix identity(int rows, int columns){                     // 단위행렬을 만듭니다.
    ...
    public static Matrix random(int rows, int columns){           // row행 column열의 임의의 값으로 채워진 행렬을 리턴합니다.
    ...
    public static Matrix scalarMultiply(double scalar, Matrix matrix){         // 행렬곱
    ...
    public static Matrix plus(Matrix first,Matrix second){                                      //행렬합
