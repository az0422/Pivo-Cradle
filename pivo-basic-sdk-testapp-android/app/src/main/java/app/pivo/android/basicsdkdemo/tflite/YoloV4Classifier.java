...
import app.pivo.android.basicsdkdemo.MainActivity;
...
public class YoloV4Classifier implements Classifier {
    ...
    //config yolov4
    private static int INPUT_SIZE = 320;
    private static int[] OUTPUT_WIDTH = new int[]{52, 26, 13};

    private static int[][] MASKS = new int[][]{{0, 1, 2}, {3, 4, 5}, {6, 7, 8}};
    private static int[] ANCHORS = new int[]{
            12, 16, 19, 36, 40, 28, 36, 75, 76, 55, 72, 146, 142, 110, 192, 243, 459, 401
    };
    private static float[] XYSCALE = new float[]{1.2f, 1.1f, 1.05f};

    private static int NUM_BOXES_PER_BLOCK = 3;
    ...
    // config yolov4 tiny
    private static int[] OUTPUT_WIDTH_TINY = new int[]{1500, 1500};
    private static int[] OUTPUT_WIDTH_FULL = new int[]{10647, 10647};
    private static int[][] MASKS_TINY = new int[][]{{3, 4, 5}, {1, 2, 3}};
    private static int[] ANCHORS_TINY = new int[]{
            23, 27, 37, 58, 81, 82, 81, 82, 135, 169, 344, 319};

    private static float[] XYSCALE_TINY = new float[]{1.05f, 1.05f};
    ...
    public static Classifier create(
        ...
        if (is_Tiny) {
            OUTPUT_WIDTH_TINY = output_shape;
        } else {
            OUTPUT_WIDTH_FULL = output_shape;
        }
...
//        float oup_scale = oupten.quantizationParams().getScale();
//        int oup_zero_point = oupten.quantizationParams().getZeroPoint();
//
//        ByteBuffer outData = ByteBuffer.allocateDirect(output_box * (numClass + 5) * (isModelQuantized ? 1 : 4));
...
//    }
    ...
    private int shape_value = 3;

    private ArrayList<Recognition> getDetectionsForFull(ByteBuffer byteBuffer, Bitmap bitmap) {
        ArrayList<Recognition> detections = new ArrayList<Recognition>();
        Map<Integer, Object> outputMap = new HashMap<>();
        outputMap.put(0, new float[1][OUTPUT_WIDTH_FULL[0]][labels.size() + 5]);
