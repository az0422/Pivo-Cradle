...
def save_tf():
  ...
  ANCHORS = utils.get_anchors(anchors, FLAGS.tiny and FLAGS.model == "yolov4")
  bbox_tensors = []
  prob_tensors = []
...
#      prob_tensors.append(output_tensors[1])
  ...
  utils.load_weights(model, FLAGS.weights, maps_id, FLAGS.model, FLAGS.tiny and FLAGS.model == "yolov4")
  model.summary()
